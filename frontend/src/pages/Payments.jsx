...
export default function Payments() {
  ...
  const fetchPayments = async () => {
    try {
      const res = await axios.get("https://smart-society-agm0.onrender.com/api/payments", config);
  ...
  const fetchResidents = async () => {
    try {
      const res = await axios.get("https://smart-society-agm0.onrender.com/api/users/residents", config);
  ...
  const savePayment = async () => {
    try {
      ...
      await axios.post("https://smart-society-agm0.onrender.com/api/payments", form, config);
  ...
  const markPaid = async (p) => {
    try {
      await axios.put(`https://smart-society-agm0.onrender.com/api/payments/${p._id}`, { status: "Paid" }, config);
      fetchPayments();
    } catch (err) {
